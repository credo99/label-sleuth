...
export const reducers = {
  ...
  setfocusedSidebarElementByIndex(state: WorkspaceState, action: PayloadAction<number>) {
...
export const extraReducers: Array<ReducerObj> = [
  ...
  },
  {
    ...
    reducer: (state: WorkspaceState, action: PayloadAction<{ pairs: [UnparsedElement, UnparsedElement][]; hit_count: number }>) => {
